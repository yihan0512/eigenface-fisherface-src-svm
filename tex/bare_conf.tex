...
\title{A Survey of Four Popular Techniques \\ used in Face Detection}
...
% in the abstract
\begin{abstract}
In this paper we explored four popular techniques used in face detection. Eigenface and fisherface are well-known subspace methods for dimension reduction, Support Vector Machine(SVM) is a widely used classifier over the past decade. We also looked into a relatively young but very powerful method, Sparse Representation-based Classfication(SRC). Experiments and comparisons were made among these four techniques. 
\end{abstract}
...
\subsection{Distribution of Projected Samples}
